# Sample Case Ana Reyes - PH eReferral Implementation Guide v0.1.0

## Sample Case Ana Reyes

# Sample Case: Ana Reyes eReferral — Initiation and Workflow Tutorial

> **Target Audience:** Connectathon participants, implementers, and developers learning how to create, send, and trace an eReferral using the PH eReferral IG profiles against a FHIR server.**Prerequisite:** Familiarity with basic FHIR concepts (resources, references, Bundles). If you are new to FHIR, read [What is FHIR?](https://www.hl7.org/fhir/overview.html) first.
...
1. [Reference Rules in This Bundle](#reference-rules-in-this-bundle)
1. [Looking Up Codes at tx.fhirlab.net](#looking-up-codes-at-txfhirlabnet)
1. [The Transaction Bundle](#the-transaction-bundle)
1. [Reading Back Resources](#reading-back-resources)
1. [Searching for Referrals](#searching-for-referrals)
1. [Tracing the Workflow — Task State Progression](#tracing-the-workflow--task-state-progression)
1. [Complete cURL Commands](#complete-curl-commands)
1. [Key Takeaways](#key-takeaways)
1. [Links to Rendered Artifacts](#links-to-rendered-artifacts)
...
1. If found — the resource is**updated**in-place
1. If not found — a**new**resource is created
...
* **Rendered**: [`Bundle-ExampleERefSubmissionBundle.html`](Bundle-ExampleERefSubmissionBundle.md) — IG-rendered view with narrative
...
1. **`received`**— Receiving facility acknowledges
1. **`accepted`**— Receiving facility accepts referral
1. **`completed`**— Referral encounter complete
1. **`rejected`**— Cannot accept referral
...
| | |
| :--- | :--- |
| ERefPatient | [StructureDefinition/ERefPatient](StructureDefinition-ereferral-patient.md) |
| ERefEncounter | [StructureDefinition/ereferral-encounter](StructureDefinition-ereferral-encounter.md) |
| ERefCondition | [StructureDefinition/ereferral-condition](StructureDefinition-ereferral-condition.md) |
| ERefObservation | [StructureDefinition/ereferral-observation](StructureDefinition-ereferral-observation.md) |
| ERefProcedure | [StructureDefinition/ereferral-procedure](StructureDefinition-ereferral-procedure.md) |
| ERefServiceRequest | [StructureDefinition/ereferral-service-request](StructureDefinition-ereferral-service-request.md) |
| ERefTask | [StructureDefinition/ereferral-task](StructureDefinition-ereferral-task.md) |
| ERefProvenance | [StructureDefinition/ereferral-provenance](StructureDefinition-ereferral-provenance.md) |
| ERefPractitionerRole | [StructureDefinition/ERefPractitionerRole](StructureDefinition-ereferral-practitioner-role.md) |

### Example Instances Used

| | |
| :--- | :--- |
| Submission Bundle (full) | [Bundle/ExampleERefSubmissionBundle](Bundle-ExampleERefSubmissionBundle.md) |
| Patient — Ana Reyes | [Patient/ExampleERefPatient](Patient-ExampleERefPatient.md) |
| ServiceRequest | [ServiceRequest/ExampleERefServiceRequest](ServiceRequest-ExampleERefServiceRequest.md) |
| Encounter | [Encounter/ExampleERefSubmissionEncounter](Encounter-ExampleERefSubmissionEncounter.md) |
| Condition — Chief Complaint | [Condition/ExampleERefConditionChiefComplaint](Condition-ExampleERefConditionChiefComplaint.md) |
| Condition — Pre-eclampsia | [Condition/ExampleERefCondition](Condition-ExampleERefCondition.md) |
| Observation — Blood Pressure | [Observation/ExampleERefObservationBP](Observation-ExampleERefObservationBP.md) |
| Observation — Heart Rate | [Observation/ExampleERefObservationHR](Observation-ExampleERefObservationHR.md) |
| Observation — Respiratory Rate | [Observation/ExampleERefObservationRR](Observation-ExampleERefObservationRR.md) |
| Observation — Oxygen Saturation | [Observation/ExampleERefObservationSpO2](Observation-ExampleERefObservationSpO2.md) |
| Observation — Temperature | [Observation/ExampleERefObservationTemp](Observation-ExampleERefObservationTemp.md) |
| Observation — Weight | [Observation/ExampleERefObservationWeight](Observation-ExampleERefObservationWeight.md) |
| Procedure | [Procedure/ExampleERefProcedureTreatment](Procedure-ExampleERefProcedureTreatment.md) |
| DiagnosticReport | [DiagnosticReport/ExampleERefDiagnosticReport](DiagnosticReport-ExampleERefDiagnosticReport.md) |
| Task — Requested | [Task/ExampleERefTaskRequested](Task-ExampleERefTaskRequested.md) |
| Provenance | [Provenance/ExampleERefProvenanceSubmission](Provenance-ExampleERefProvenanceSubmission.md) |
| Practitioner — Dr. Villanueva | [Practitioner/ExampleERefPractitionerSubmission](Practitioner-ExampleERefPractitionerSubmission.md) |
| Practitioner — Dr. Carlos Lim | [Practitioner/ExampleERefPractitionerReceiving](Practitioner-ExampleERefPractitionerReceiving.md) |
| Organization — KHC | [Organization/ExampleERefOrganizationKaliboHC](Organization-ExampleERefOrganizationKaliboHC.md) |
| Organization — DRSTMH | [Organization/ExampleERefOrganizationDRSTMH](Organization-ExampleERefOrganizationDRSTMH.md) |
| PractitionerRole — KHC | [PractitionerRole/ExampleERefPractitionerRoleSubmission](PractitionerRole-ExampleERefPractitionerRoleSubmission.md) |
| PractitionerRole — DRSTMH | [PractitionerRole/ExampleERefPractitionerRoleReceiving](PractitionerRole-ExampleERefPractitionerRoleReceiving.md) |
